            ...
            <div class="card card_color">
                <form action="{{route('empleado.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-content">
                        <span class="card-title titulo text_color">Registrar un empleado</span>
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input  id="cargo" name="cargo" type="text" class="validate" oninvalid="setCustomValidity('Ingresa un cargo')" oninput="setCustomValidity('')" required>
