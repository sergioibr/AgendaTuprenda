    ...
    <div class="row">
        <div class="col s12 m10 l8 xl8 offset-m1 offset-l2 offset-xl2">
            <div class="card">
                ...
                <h5 style="text-align: center">Detalle del Administrador</h5>
                    <hr>
                    <br>
                    <div class="row">
                ...
                <div class="card-action cancel-primary-color">
                    <a href="{{route('administrador.index')}}" class="btn blue darken-4 waves-effect waves-light" type="submit">aceptar</a>
