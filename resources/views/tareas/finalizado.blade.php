                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input  id="descripcion" name="descripcion" value="{{$tarea->descripcion}}" type="text" class="validate" oninvalid="setCustomValidity('Ingresa la Descripcion')" oninput="setCustomValidity('')" readonly>
                                <label for="descripcion">Descripcion :</label>
                            </div>

                            <div class="input-field col s6">
                                <input  id="tipo_tarea" name="tipo_tarea" value="{{$tarea->tipo_tarea}}" type="text" class="validate" oninvalid="setCustomValidity('Ingresa el tipo de tarea')" oninput="setCustomValidity('')" readonly>
                                <label for="tipo_tarea">Tipo de Tarea :</label>
                            </div>

                            <div class="input-field col s6">
                                <input id="duracionEstimada" name="duracionEstimada" value="{{$tarea->duracionEstimada}}" type="text" class="validate" oninvalid="setCustomValidity('Ingresa la duracion')" oninput="setCustomValidity('')" readonly>
                            ...
                            <div class="input-field col s6">
                                <select name="prioridad" oninvalid="setCustomValidity('Seleccione una prioridad')" oninput="setCustomValidity('')" readonly>
                                    <option value="" disabled selected>Escoja uno</option>
                            ...
                            <div class="input-field col s6">
                                <select name="id_persona" oninvalid="setCustomValidity('Seleccione un persona')" oninput="setCustomValidity('')" readonly>
                            ...
                            <div class="input-field col s12 m6">
                                <select name="id_item" oninvalid="setCustomValidity('Seleccione un persona')" oninput="setCustomValidity('')" readonly>
                                    <option value="" disabled selected>Escoja uno</option>
